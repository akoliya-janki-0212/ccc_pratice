...
//pop elemene end of array- array_pop() time complexicy- o(n)
...
//add element begining of array- array_unshift() time complexicy- o(n)
...
$arr1=array_splice($arr,2,5,array('one','two'));
print_r($arr1);
echo '<br>';
print_r($arr);
echo '<br>'; */
...
$arr=array(1,2,0,3,7,5);
$arr1=array_slice($arr,2,5);
print_r($arr1);
echo '<br>';
print_r($arr);
echo '<br>';
