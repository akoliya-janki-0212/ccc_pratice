...
function set_value($result)
{
      ...
      $products['manufecturer_cost']=isset($row['manufacturer_cost'])?$row['manufacturer_cost']:" ";
      ...
      <div class="content">
        ...
        if($action=='edit'){
          ...
          <div class="form-group">
            ...
            <input type="textbox" class="form-control" id="manufacturer_cost" name="product[manufacturer_cost]" value="<?php echo $products['manufecturer_cost'];?>" placeholder="Enter Manufacturer Cost">
          </div>
          <div class="form-group">
